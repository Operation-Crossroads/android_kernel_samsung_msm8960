...
export ARCH=arm;
export CROSS_COMPILE=~/gcc-toolchains/arm-none-eabi-4.8/bin/arm-none-eabi-;

export PATH=~/gcc-toolchains/arm-none-eabi-4.8/bin/cache:~/gcc-toolchains/arm-none-eabi-4.8/bin:$PATH;
